...
namespace apl.Log
{
    ...
    public class Cadena
    {
        ...
        //#region +_ Cantidad en letra (Dolares)
        /// <summary>
        ...
        private static bool TermPad()
        {
            /*
            string cadena = Configuracion.LeeConfiguracion(string.Empty, "Aplicativo", "TERMPAD");
            return cadena == "TRUE";*/
            return true;
        }
        ...
        public static string Terminacion(decimal _monto, string _nombres, string _terminacion)
        {
            ...
            if (_monto == 1.0m)
                ...
                text = arrtoks.Length > 1 ? arrtoks[1] : "";
